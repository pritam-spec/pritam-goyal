...
OUTPUT_DIR = os.getenv("OUTPUT_DIR", "output_reduce_3")
RAW_JSON_DIR = os.getenv("RAW_JSON_DIR", "output_reduce_rawjson_3")
SENT_IMG_DIR = Path("output_reduce_3/images")
SENT_PDF_DIR = Path("output_reduce_3/pdfs")
