...
# I/O
PDF_INPUT_DIR = os.getenv("PDF_INPUT_DIR", "test_ler")
OUTPUT_DIR = os.getenv("OUTPUT_DIR", "output_reduce_ler")
RAW_JSON_DIR = os.getenv("RAW_JSON_DIR", "output_reduce_rawjson_ler")
SENT_IMG_DIR = Path("output_reduce_ler/images")
SENT_PDF_DIR = Path("output_reduce_ler/pdfs")
...
def _llm_worker_from_bytes(pdf_path: Path, pdf_stem: str, pno: int, pre: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        # ------------------ NEW: repair tables using local spans ------------------
        try:
        ...
        # ------------------ NEW: detect missing charts from local text ------------------
        try:
